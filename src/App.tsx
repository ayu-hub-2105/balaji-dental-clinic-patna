...
function MainWebsite() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans antialiased relative selection:bg-sky-500 selection:text-white pb-24 md:pb-0">
        ...
        {currentView === 'home' && (
          <>
            <Hero
              ...
              onDoctorClick={handleOpenDoctorProfile}
            />
      ...
      {/* Doctor Profile Modal (Triggered globally from Hero, Footer, or any Section) */}
      <DoctorProfileModal
