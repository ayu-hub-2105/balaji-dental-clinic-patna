...
export const AdminDashboard: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'appointments' | 'patients' | 'leads' | 'integrations' | 'chat'>('appointments');
    ...
    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex flex-col overflow-hidden text-left animate-fadeIn">
      ...
      <div className="flex-1 flex overflow-hidden bg-slate-50">
          ...
          <nav className="space-y-1.5">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="hidden sm:inline">Patient Database</span>
              </div>
              <span
                className={`hidden sm:inline text-[11px] px-2 py-0.5 rounded-full font-bold ${
                  activeTab === 'patients'
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="hidden sm:inline">Patient Leads</span>
              </div>
              <span
                className={`hidden sm:inline text-[11px] px-2 py-0.5 rounded-full font-bold ${
                  activeTab === 'leads'
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="hidden sm:inline">Connected Channels</span>
              </div>
            ...
            >
              ...
              <span className="hidden sm:inline">Clinic Overview</span>
            </button>
            ...
            >
              ...
              <span className="hidden sm:inline">Patient Messages</span>
            </button>
          </nav>
        ...
        <main className="flex-1 overflow-y-auto p-5 sm:p-8 bg-slate-50 text-slate-800">
          ...
          {/* TAB: PATIENT DATABASE & CLINICAL RECORDS (मरीज़ डेटाबेस) */}
          {activeTab === 'patients' && (
            ...
            <div className="space-y-6 max-w-6xl mx-auto">
              <div>
                <h2 className="text-2xl font-extrabold text-slate-900 font-heading">
                  Multi-Channel Ingestion Overview
                </h2>
                <p className="text-xs text-slate-500 mt-1">
                  Real-time analytics across Remedo, Dr. Klick, Balaji official website, and WhatsApp.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-2">
                  ...
                  <div className="flex items-baseline justify-between">
                    ...
                    <span className="text-xs font-bold text-emerald-600 flex items-center">
                      <TrendingUp className="w-3.5 h-3.5 mr-0.5" /> Live Sync
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-500">Aggregated in one dashboard</p>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-purple-50/70 border border-purple-200 space-y-2">
                  ...
                  <div className="flex items-baseline justify-between">
                    <span className="text-3xl font-extrabold text-purple-900">{remedoCount}</span>
                    <span className="text-xs font-bold text-purple-700">Partner Active</span>
                  </div>
                  <p className="text-[11px] text-purple-600">Synced from Remedo portal</p>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-cyan-50/70 border border-cyan-200 space-y-2">
                  ...
                  <div className="flex items-baseline justify-between">
                    <span className="text-3xl font-extrabold text-cyan-900">{drKlickCount}</span>
                    <span className="text-xs font-bold text-cyan-700">Bridge Active</span>
                  </div>
                  <p className="text-[11px] text-cyan-600">Synced from Dr. Klick portal</p>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-sky-50/70 border border-sky-200 space-y-2">
                  ...
                  <div className="flex items-baseline justify-between">
                    <span className="text-3xl font-extrabold text-sky-900">{websiteCount}</span>
                    <span className="text-xs font-bold text-sky-700">Direct Engine</span>
                  </div>
                  <p className="text-[11px] text-sky-600">From balajidental.com</p>
                </div>
              </div>

              {/* Channel Distribution */}
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-4">
                <h3 className="text-base font-bold text-slate-900">Appointments Breakdown by Channel</h3>
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                  {[
                    { name: 'Remedo', count: remedoCount, color: 'bg-purple-500', text: 'text-purple-800' },
                    { name: 'Dr. Klick', count: drKlickCount, color: 'bg-cyan-500', text: 'text-cyan-800' },
                    { name: 'Website', count: websiteCount, color: 'bg-sky-500', text: 'text-sky-800' },
                    { name: 'WhatsApp', count: whatsappCount, color: 'bg-emerald-500', text: 'text-emerald-800' },
                    { name: 'Phone/Walk-in', count: phoneCount, color: 'bg-amber-500', text: 'text-amber-800' }
                  ].map((item) => (
                    <div
                      key={item.name}
